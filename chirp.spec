...
Version  : 20231031
Release  : 30
URL      : https://trac.chirp.danplanet.com/chirp_next/next-20231031/chirp-20231031.tar.gz
Source0  : https://trac.chirp.danplanet.com/chirp_next/next-20231031/chirp-20231031.tar.gz
...
%prep
%setup -q -n chirp-20231031
cd %{_builddir}/chirp-20231031
%patch -P 1 -p1
pushd ..
cp -a chirp-20231031 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698762533
