...
Version  : 20250307
Release  : 100
URL      : https://trac.chirp.danplanet.com/chirp_next/next-20250307/chirp-20250307.tar.gz
Source0  : https://trac.chirp.danplanet.com/chirp_next/next-20250307/chirp-20250307.tar.gz
...
%prep
%setup -q -n chirp-20250307
cd %{_builddir}/chirp-20250307
%patch -P 1 -p1
pushd ..
cp -a chirp-20250307 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1741794684
