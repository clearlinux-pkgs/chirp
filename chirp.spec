...
Version  : 20231016
Release  : 27
URL      : https://trac.chirp.danplanet.com/chirp_next/next-20231016/chirp-20231016.tar.gz
Source0  : https://trac.chirp.danplanet.com/chirp_next/next-20231016/chirp-20231016.tar.gz
...
%prep
%setup -q -n chirp-20231016
cd %{_builddir}/chirp-20231016
%patch -P 1 -p1
pushd ..
cp -a chirp-20231016 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697465624
