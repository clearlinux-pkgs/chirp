...
Version  : 20250502
Release  : 101
URL      : https://trac.chirp.danplanet.com/chirp_next/next-20250502/chirp-20250502.tar.gz
Source0  : https://trac.chirp.danplanet.com/chirp_next/next-20250502/chirp-20250502.tar.gz
...
%prep
%setup -q -n chirp-20250502
cd %{_builddir}/chirp-20250502
%patch -P 1 -p1
pushd ..
cp -a chirp-20250502 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1746743852
