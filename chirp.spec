...
Version  : 20231003
Release  : 26
URL      : https://trac.chirp.danplanet.com/chirp_next/next-20231003/chirp-20231003.tar.gz
Source0  : https://trac.chirp.danplanet.com/chirp_next/next-20231003/chirp-20231003.tar.gz
...
%prep
%setup -q -n chirp-20231003
cd %{_builddir}/chirp-20231003
%patch -P 1 -p1
pushd ..
cp -a chirp-20231003 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1696341848
