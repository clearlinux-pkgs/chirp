...
Version  : 20240322
Release  : 58
URL      : https://trac.chirp.danplanet.com/chirp_next/next-20240322/chirp-20240322.tar.gz
Source0  : https://trac.chirp.danplanet.com/chirp_next/next-20240322/chirp-20240322.tar.gz
...
%prep
%setup -q -n chirp-20240322
cd %{_builddir}/chirp-20240322
%patch -P 1 -p1
pushd ..
cp -a chirp-20240322 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711126502
