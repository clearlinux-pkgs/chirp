...
Version  : 20230823
Release  : 16
URL      : https://trac.chirp.danplanet.com/chirp_next/next-20230823/chirp-20230823.tar.gz
Source0  : https://trac.chirp.danplanet.com/chirp_next/next-20230823/chirp-20230823.tar.gz
...
%prep
%setup -q -n chirp-20230823
cd %{_builddir}/chirp-20230823
%patch -P 1 -p1
pushd ..
cp -a chirp-20230823 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1692800954
