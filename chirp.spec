...
Source0  : https://trac.chirp.danplanet.com/chirp_next/next-20240926/chirp-20240926.tar.gz
...
%prep
%setup -q -n chirp-20240926
cd %{_builddir}/chirp-20240926
%patch -P 1 -p1
pushd ..
cp -a chirp-20240926 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1727359691
