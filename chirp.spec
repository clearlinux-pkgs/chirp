...
Version  : 20240208
Release  : 52
URL      : https://trac.chirp.danplanet.com/chirp_next/next-20240208/chirp-20240208.tar.gz
Source0  : https://trac.chirp.danplanet.com/chirp_next/next-20240208/chirp-20240208.tar.gz
...
Patch2: 0002-Remove-dependency-on-future-which-doesn-t-work-in-Py.patch
...
%prep
%setup -q -n chirp-20240208
cd %{_builddir}/chirp-20240208
%patch -P 1 -p1
%patch -P 2 -p1
pushd ..
cp -a chirp-20240208 buildavx2
popd
pushd ..
cp -a chirp-20240208 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707403503
