...
Version  : 20240502
Release  : 62
URL      : https://trac.chirp.danplanet.com/chirp_next/next-20240502/chirp-20240502.tar.gz
Source0  : https://trac.chirp.danplanet.com/chirp_next/next-20240502/chirp-20240502.tar.gz
...
%prep
%setup -q -n chirp-20240502
cd %{_builddir}/chirp-20240502
%patch -P 1 -p1
pushd ..
cp -a chirp-20240502 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1714838057
