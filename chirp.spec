...
Source0  : https://trac.chirp.danplanet.com/chirp_next/next-20231207/chirp-20231207.tar.gz
...
%prep
%setup -q -n chirp-20231207
cd %{_builddir}/chirp-20231207
%patch -P 1 -p1
%patch -P 2 -p1
pushd ..
cp -a chirp-20231207 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1701973998
