...
Version  : 20240514
Release  : 69
URL      : https://trac.chirp.danplanet.com/chirp_next/next-20240514/chirp-20240514.tar.gz
Source0  : https://trac.chirp.danplanet.com/chirp_next/next-20240514/chirp-20240514.tar.gz
...
%prep
%setup -q -n chirp-20240514
cd %{_builddir}/chirp-20240514
%patch -P 1 -p1
pushd ..
cp -a chirp-20240514 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715695817
