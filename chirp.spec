...
Version  : 20250131
Release  : 99
URL      : https://trac.chirp.danplanet.com/chirp_next/next-20250131/chirp-20250131.tar.gz
Source0  : https://trac.chirp.danplanet.com/chirp_next/next-20250131/chirp-20250131.tar.gz
...
%prep
%setup -q -n chirp-20250131
cd %{_builddir}/chirp-20250131
%patch -P 1 -p1
pushd ..
cp -a chirp-20250131 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738364812
