...
Version  : 20240206
Release  : 51
URL      : https://trac.chirp.danplanet.com/chirp_next/next-20240206/chirp-20240206.tar.gz
Source0  : https://trac.chirp.danplanet.com/chirp_next/next-20240206/chirp-20240206.tar.gz
...
%prep
%setup -q -n chirp-20240206
cd %{_builddir}/chirp-20240206
%patch -P 1 -p1
%patch -P 2 -p1
pushd ..
cp -a chirp-20240206 buildavx2
popd
pushd ..
cp -a chirp-20240206 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707230785
