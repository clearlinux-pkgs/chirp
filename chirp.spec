...
Version  : 20230818
Release  : 15
URL      : https://trac.chirp.danplanet.com/chirp_next/next-20230818/chirp-20230818.tar.gz
Source0  : https://trac.chirp.danplanet.com/chirp_next/next-20230818/chirp-20230818.tar.gz
...
%prep
%setup -q -n chirp-20230818
cd %{_builddir}/chirp-20230818
%patch -P 1 -p1
pushd ..
cp -a chirp-20230818 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1692368322
