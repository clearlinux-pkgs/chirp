...
Version  : 20230722
Release  : 7
URL      : https://trac.chirp.danplanet.com/chirp_next/next-20230722/chirp-20230722.tar.gz
Source0  : https://trac.chirp.danplanet.com/chirp_next/next-20230722/chirp-20230722.tar.gz
...
%prep
%setup -q -n chirp-20230722
cd %{_builddir}/chirp-20230722
%patch -P 1 -p1
pushd ..
cp -a chirp-20230722 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1690207098
