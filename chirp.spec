...
Version  : 20230924
Release  : 24
URL      : https://trac.chirp.danplanet.com/chirp_next/next-20230924/chirp-20230924.tar.gz
Source0  : https://trac.chirp.danplanet.com/chirp_next/next-20230924/chirp-20230924.tar.gz
...
%prep
%setup -q -n chirp-20230924
cd %{_builddir}/chirp-20230924
%patch -P 1 -p1
pushd ..
cp -a chirp-20230924 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1695651536
