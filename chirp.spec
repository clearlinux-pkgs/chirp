...
Version  : 20240606
Release  : 71
URL      : https://trac.chirp.danplanet.com/chirp_next/next-20240606/chirp-20240606.tar.gz
Source0  : https://trac.chirp.danplanet.com/chirp_next/next-20240606/chirp-20240606.tar.gz
...
%prep
%setup -q -n chirp-20240606
cd %{_builddir}/chirp-20240606
%patch -P 1 -p1
pushd ..
cp -a chirp-20240606 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1717689502
