...
Version  : 20240410
Release  : 59
URL      : https://trac.chirp.danplanet.com/chirp_next/next-20240410/chirp-20240410.tar.gz
Source0  : https://trac.chirp.danplanet.com/chirp_next/next-20240410/chirp-20240410.tar.gz
...
%prep
%setup -q -n chirp-20240410
cd %{_builddir}/chirp-20240410
%patch -P 1 -p1
pushd ..
cp -a chirp-20240410 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712791541
