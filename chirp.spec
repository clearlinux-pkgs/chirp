...
Source0  : https://trac.chirp.danplanet.com/chirp_next/next-20240911/chirp-20240911.tar.gz
...
%prep
%setup -q -n chirp-20240911
cd %{_builddir}/chirp-20240911
%patch -P 1 -p1
pushd ..
cp -a chirp-20240911 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726087261
