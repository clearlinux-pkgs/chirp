...
Version  : 20240626
Release  : 74
URL      : https://trac.chirp.danplanet.com/chirp_next/next-20240626/chirp-20240626.tar.gz
Source0  : https://trac.chirp.danplanet.com/chirp_next/next-20240626/chirp-20240626.tar.gz
...
%prep
%setup -q -n chirp-20240626
cd %{_builddir}/chirp-20240626
%patch -P 1 -p1
pushd ..
cp -a chirp-20240626 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719411534
