...
Version  : 20240117
Release  : 46
URL      : https://trac.chirp.danplanet.com/chirp_next/next-20240117/chirp-20240117.tar.gz
Source0  : https://trac.chirp.danplanet.com/chirp_next/next-20240117/chirp-20240117.tar.gz
...
%prep
%setup -q -n chirp-20240117
cd %{_builddir}/chirp-20240117
%patch -P 1 -p1
%patch -P 2 -p1
pushd ..
cp -a chirp-20240117 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1705498874
