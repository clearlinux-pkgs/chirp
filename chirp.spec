...
Version  : 20250516
Release  : 102
URL      : https://trac.chirp.danplanet.com/chirp_next/next-20250516/chirp-20250516.tar.gz
Source0  : https://trac.chirp.danplanet.com/chirp_next/next-20250516/chirp-20250516.tar.gz
...
BuildRequires : pypi(lark_parser)
...
%prep
%setup -q -n chirp-20250516
cd %{_builddir}/chirp-20250516
%patch -P 1 -p1
pushd ..
cp -a chirp-20250516 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1748368634
