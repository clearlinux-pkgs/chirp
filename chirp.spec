...
Version  : 20241101
Release  : 90
URL      : https://trac.chirp.danplanet.com/chirp_next/next-20241101/chirp-20241101.tar.gz
Source0  : https://trac.chirp.danplanet.com/chirp_next/next-20241101/chirp-20241101.tar.gz
...
%prep
%setup -q -n chirp-20241101
cd %{_builddir}/chirp-20241101
%patch -P 1 -p1
pushd ..
cp -a chirp-20241101 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730473542
