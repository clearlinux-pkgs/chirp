...
Version  : 20230731
Release  : 9
URL      : https://trac.chirp.danplanet.com/chirp_next/next-20230731/chirp-20230731.tar.gz
Source0  : https://trac.chirp.danplanet.com/chirp_next/next-20230731/chirp-20230731.tar.gz
...
%prep
%setup -q -n chirp-20230731
cd %{_builddir}/chirp-20230731
%patch -P 1 -p1
pushd ..
cp -a chirp-20230731 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1690812848
