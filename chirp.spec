...
Version  : 20240111
Release  : 45
URL      : https://trac.chirp.danplanet.com/chirp_next/next-20240111/chirp-20240111.tar.gz
Source0  : https://trac.chirp.danplanet.com/chirp_next/next-20240111/chirp-20240111.tar.gz
...
%prep
%setup -q -n chirp-20240111
cd %{_builddir}/chirp-20240111
%patch -P 1 -p1
%patch -P 2 -p1
pushd ..
cp -a chirp-20240111 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1704983525
