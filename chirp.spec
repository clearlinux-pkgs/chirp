...
Version  : 20241108
Release  : 91
URL      : https://trac.chirp.danplanet.com/chirp_next/next-20241108/chirp-20241108.tar.gz
Source0  : https://trac.chirp.danplanet.com/chirp_next/next-20241108/chirp-20241108.tar.gz
...
%prep
%setup -q -n chirp-20241108
cd %{_builddir}/chirp-20241108
%patch -P 1 -p1
pushd ..
cp -a chirp-20241108 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1731078132
