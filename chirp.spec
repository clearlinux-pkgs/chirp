...
Source0  : https://trac.chirp.danplanet.com/chirp_next/next-20250124/chirp-20250124.tar.gz
...
%prep
%setup -q -n chirp-20250124
cd %{_builddir}/chirp-20250124
%patch -P 1 -p1
pushd ..
cp -a chirp-20250124 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737763324
