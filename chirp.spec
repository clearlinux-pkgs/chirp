...
Version  : 20240531
Release  : 70
URL      : https://trac.chirp.danplanet.com/chirp_next/next-20240531/chirp-20240531.tar.gz
Source0  : https://trac.chirp.danplanet.com/chirp_next/next-20240531/chirp-20240531.tar.gz
...
%prep
%setup -q -n chirp-20240531
cd %{_builddir}/chirp-20240531
%patch -P 1 -p1
pushd ..
cp -a chirp-20240531 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1717424229
