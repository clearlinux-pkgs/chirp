...
Source0  : https://trac.chirp.danplanet.com/chirp_next/next-20231108/chirp-20231108.tar.gz
...
%prep
%setup -q -n chirp-20231108
cd %{_builddir}/chirp-20231108
%patch -P 1 -p1
pushd ..
cp -a chirp-20231108 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1699456011
