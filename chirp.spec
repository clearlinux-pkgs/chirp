...
Version  : 20230906
Release  : 20
URL      : https://trac.chirp.danplanet.com/chirp_next/next-20230906/chirp-20230906.tar.gz
Source0  : https://trac.chirp.danplanet.com/chirp_next/next-20230906/chirp-20230906.tar.gz
...
%prep
%setup -q -n chirp-20230906
cd %{_builddir}/chirp-20230906
%patch -P 1 -p1
pushd ..
cp -a chirp-20230906 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1694009178
