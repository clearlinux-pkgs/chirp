...
Source0  : https://trac.chirp.danplanet.com/chirp_next/next-20230928/chirp-20230928.tar.gz
...
%prep
%setup -q -n chirp-20230928
cd %{_builddir}/chirp-20230928
%patch -P 1 -p1
pushd ..
cp -a chirp-20230928 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1695912049
