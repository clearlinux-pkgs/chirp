...
Version  : 20230714
Release  : 4
URL      : https://trac.chirp.danplanet.com/chirp_next/next-20230714/chirp-20230714.tar.gz
Source0  : https://trac.chirp.danplanet.com/chirp_next/next-20230714/chirp-20230714.tar.gz
...
%prep
%setup -q -n chirp-20230714
cd %{_builddir}/chirp-20230714
%patch -P 1 -p1
pushd ..
cp -a chirp-20230714 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1689344962
