...
Version  : 20240706
Release  : 75
URL      : https://trac.chirp.danplanet.com/chirp_next/next-20240706/chirp-20240706.tar.gz
Source0  : https://trac.chirp.danplanet.com/chirp_next/next-20240706/chirp-20240706.tar.gz
...
%prep
%setup -q -n chirp-20240706
cd %{_builddir}/chirp-20240706
%patch -P 1 -p1
pushd ..
cp -a chirp-20240706 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720450537
